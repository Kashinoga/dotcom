...
const sidebars = {
    ...
    projects: [
        'intro',
        {
            ...
            type: 'category',
            label: 'Tabletop RPGs',
            items: ['tabletop-rpgs/intro',
                {
                    collapsed: false,
                    type: 'category',
                    label: 'Dungeons and Dragons',
                    items: [
                        'tabletop-rpgs/dungeons-and-dragons/intro'
                    ]
                }
            ],
        },
        {
            collapsed: false,
            type: 'category',
            label: 'The Maker Universe',
            items: ['the-maker-universe/intro'
            ],
        },
        {
            collapsed: false,
            type: 'category',
            label: 'Project Starbloom',
            items: ['project-starbloom/intro'
            ],
        }
    ]
